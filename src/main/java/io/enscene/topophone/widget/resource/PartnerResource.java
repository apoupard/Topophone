...
public class PartnerResource {
  ...
  public Map<String, Collection<Partner>> getPartners() throws IOException, TemplateException {
    return ImmutableMultimap.<String, Partner>builder()
        .put("Institutionnels", new Partner("Institutionnels", "/images/partners/fse.png", "<span class=\"bold\">Le fonds social européen</span> (FSE) est l'un des fonds structurels de l'Union européenne. Il contribue à l'objectif \"Compétitivité régionale et emploi\" de la politique de cohésion de l'Union européenne. <br> Le FSE soutient Topophone sur les actions en CLAE et en entreprises."))
  ...
  public String getHtmlProfile(@PathParam("template") String template) throws IOException, TemplateException {
