...
public class MainDao extends AstractHardCoded<Main> {
  ...
  void init(Map<String, Main> database) {
    database.put("1", new Main(new HeadbandCarousel(getAllHeadbandImages(), "/images/education/headbandlogo.png"), getEnginedTemplate("main", "description"), new Youtube("l3kcrbm2aNc"), new Youtube("D1QOwfWPUZI")));
  }
