...
public class ArtistDaoHardCoded extends AstractHardCoded<Artist> {
  ...
  private Artist getInternationalHyperRythmique(String id) {
    ...
    List<Concert> concerts =
        ImmutableList.of(new Concert(new GregorianCalendar(2015, 06, 11).getTime(), "Club liberté",
            ...
            "Helsinki"));
    return new Artist(getProfileImage(id), getSocialMedia(id), song, concerts, getDescription(),
  ...
  private Artist getLeCommonDiamond(String id) {
    ...
    List<Concert> concerts =
        ImmutableList.of(new Concert(new GregorianCalendar(2015, 06, 11).getTime(), "Club liberté",
            "Helsinki"), new Concert(new GregorianCalendar(2015, 06, 12).getTime(), "Mbar",
            "Helsinki"));
    return new Artist(getProfileImage(id), medias, song, concerts, getDescription(),
  ...
  public String getDescription() {
    return "<h3>Bio</h3>" + "<p>Floran et Thomas puisent dans le solaire et"
        ...
        + "    couple s’inspire mais ne réchauffe pas.</p>" + "<h3>Actu</h3>"
        + "<p>Selection 15/12 connexion Toulouse<br/>Début de la tournée nationale</p>"
        + "<h3>Ils en parlent</h3>" + "<p><span class=\"GDPD4GNPJ\">Madame Le Figaro</span><br/>"
        ...
        + "    “The moodiness of Air, the sexuality of Sébastien Tellier”" + "</p>";
  }
